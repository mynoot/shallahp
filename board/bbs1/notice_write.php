  ...
  <div class="container-fluid">
    ...
    <form class="navbar-form navbar-left">
      ...
      <div class="navbar-right navbar-brand">
        ...
        <a href="../../member/sign_up.php"><strong>Sign-Up</strong></a>
...
<div style="text-align:center;">
  ...
  <tr>
      <td width='100%' height='30' colspan='2' bgcolor='FFFFF' align='center'> - 공지게시판 글쓰기 -</td>

  <form name='write' action='notice_write_post.php' method='post' enctype='multipart/form-data'>
